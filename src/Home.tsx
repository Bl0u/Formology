...
const Home: React.FC = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      } else if (projectsSection && window.scrollY > projectsSection.offsetTop - 200) {
        setActiveSection('projects');
      } else if (aboutSection && window.scrollY > aboutSection.offsetTop - 200) {
  ...
  return (
    <div className="home-container">
      ...
      >
        ...
        <nav>
          <ul>
            {['Home', 'About', 'Projects', 'Login', 'Contact'].map((item) => (
              <motion.li 
                key={item}
      ...
      <section id="hero" className="hero-section">
        ...
        >
          ...
          >
            A clean, minimal approach to modern design that focuses on what truly matters.
          </motion.p>
      ...
      <section id="about" className="about-section">
        ...
        <div className="feature-cards">
          {[
            { title: "Minimalist", description: "Less is more. Focus on what really matters." },
            { title: "Animated", description: "Subtle movements bring your content to life." },
            { title: "Responsive", description: "Looks great on every device, every time." }
          ].map((feature, index) => (
            <motion.div 
